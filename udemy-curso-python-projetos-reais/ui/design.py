...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 556, 264))
        ...
        self.btnAbrirArquivo = QtWidgets.QPushButton(self.centralwidget)
        self.btnAbrirArquivo.setObjectName("btnAbrirArquivo")
        self.gridLayout.addWidget(self.btnAbrirArquivo, 1, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnAbrirArquivo.setText(_translate("MainWindow", "Escolher arquivo"))
